...
int main(int argc, char *argv[]) {
  ...
  while (cupsRasterReadHeader2(pRasterSrc, &tHeader)) {
    ...
    int foo = min(tHeader.cupsWidth, iMaxWidth); // 0x240 for 80mm (72mm impresora)
    // int foo = ( header.cupsWidth > 0x240 ) ? 0x240 : header.cupsWidth; //forzar un tamaño en especifico
